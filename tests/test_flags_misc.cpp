...
TEST_CASE("DAA edge cases update all documented flags", "[flags]") {
    ...
    const DaaCase cases[] = {
        ...
        {0x7d, 0x00, 0x83, 0x90}, {0x12, 0x00, 0x12, 0x04}, {0x1a, 0x00, 0x20, 0x20}, {0x90, 0x01, 0xf0, 0x84},
        {0xfa, 0x00, 0x60, 0x25}, {0xa0, 0x01, 0x00, 0x45}, {0x15, 0x02, 0x1b, 0x08}, {0x9f, 0x02, 0x05, 0x05},
        {0xff, 0x03, 0x65, 0x25}, {0x0f, 0x12, 0x09, 0x0e}, {0x13, 0x12, 0x0d, 0x0c}, {0x73, 0x13, 0x13, 0x03},
        {0x00, 0x13, 0xa0, 0x83}, {0x66, 0x03, 0x00, 0x45},
    };
