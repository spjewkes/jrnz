...
TEST_CASE("Undocumented indexed CB register-copy forms populate every destination register",
    ...
    SECTION("FDCB RES forms copy the updated byte into each register target while preserving flags") {
        ...
        const CopyCase cases[] = {
            {0x80, 0x7f, 0x21, 0x31, 0x41, 0x51, 0x61, 0x71}, {0x81, 0x11, 0x7f, 0x31, 0x41, 0x51, 0x61, 0x71},
            {0x82, 0x11, 0x21, 0x7f, 0x41, 0x51, 0x61, 0x71}, {0x83, 0x11, 0x21, 0x31, 0x7f, 0x51, 0x61, 0x71},
            {0x84, 0x11, 0x21, 0x31, 0x41, 0x7f, 0x61, 0x71}, {0x85, 0x11, 0x21, 0x31, 0x41, 0x51, 0x7f, 0x71},
            {0x87, 0x11, 0x21, 0x31, 0x41, 0x51, 0x61, 0x7f},
        };
