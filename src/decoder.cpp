...
void init_map_inst()
{
	...
	map_inst.emplace(0x2f, Instruction{InstType::JP,   "jp p, **",   3, 10, Conditional::P, Operand::PC, Operand::NN});
	...
	map_inst.emplace(0xed78, Instruction{InstType::IN,   "in a, (c)",  2, 12, Operand::A, Operand::PORT});
