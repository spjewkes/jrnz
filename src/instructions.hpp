...
private:
	...
	size_t impl_rotate_left(Z80 &state, StorageElement &elem, bool set_state, bool carry_inst);
	size_t impl_rotate_right(Z80 &state, StorageElement &elem, bool set_state, bool carry_inst);
