...
// Define this to enable a window to test keyboard and display - this will need
// some further refinement before being set always
 ...
 */
enum class Conditional { ALWAYS, NEVER, Z, NZ, C, NC, M, P, PE, PO, UNUSED };

/**
 * @brief Defines the operands that can be passed into an instruction handling
 * function
 */
enum class Operand {
    AF,
